            ...
            if radar_configs['data_type'] == 'RI' or radar_configs['data_type'] == 'AP':  # drop this format
                ...
                for idx, frameid in enumerate(
                    ...
                    if self.split != 'test':
                        ...
                        data_dict['radar_paths'].append(radar_paths[frameid])
                ...
                for idx, frameid in enumerate(
                    ...
                    if self.split != 'test':
                        ...
                        data_dict['radar_paths'].append(radar_paths[frameid][chirp_id])
            else:
