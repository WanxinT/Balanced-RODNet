...
def parse_args():
    ...
    parser.add_argument('--overwrite', action="store_true", default=True, help="overwrite prepared data if exist")
...
def prepare_data(dataset, config_dict, data_dir, split, save_dir, viz=False, overwrite=False):
    ...
    data_root = config_dict['dataset_cfg']['demo_root']
